...
front_left_motor  ( new Talon(Ports::PWMBusIDs::FRONT_LEFT_MOTOR)  ),
front_right_motor ( new Talon(Ports::PWMBusIDs::FRONT_RIGHT_MOTOR) ),
back_left_motor   ( new Talon(Ports::PWMBusIDs::BACK_LEFT_MOTOR)   ),
back_right_motor  ( new Talon(Ports::PWMBusIDs::BACK_RIGHT_MOTOR)  ),
scale (0.5) {
